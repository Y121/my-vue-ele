<template>
  <div id="head_top">
    ...
    <!--搜索框-->
    <div v-if="goBack" class="head_back" @click="$router.go(-1)">
      <!--返回按钮-->
      <span class="iconfont">&#xe771;</span>
    </div>
    <div class="head_center" v-if="headTitle">
      <!--标题内容-->
    ...
    <!--这个也是页面标题，是因为这个页面的标题还可以点击跳转页面，所以要特别写一个插槽占位-->
...
@import "../../assets/css/common/mixin.scss"; //此处应以分号结尾，否则会报错。
#head_top {
  position: fixed;
  left: 0;
  top: 0;
